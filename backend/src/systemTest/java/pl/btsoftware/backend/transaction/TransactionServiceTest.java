...
public class TransactionServiceTest {
        ...
        void shouldRetrieveTransactionsByAccountId() {
                ...
                var incomeCategoryId = createIncomeCategory(userId);
                var expenseCategoryId = createExpenseCategory(userId);
                var account1Id = accountModuleFacade
                        .createAccount(new CreateAccountCommand(uniqueAccountName(), PLN, userId));
                var account2Id = accountModuleFacade
                        .createAccount(new CreateAccountCommand(uniqueAccountName(), PLN, userId));
        ...
        void shouldDeleteTransactionAndAdjustAccountBalance() {
                ...
                var deletedTransaction = transactionRepository
                        .findByIdIncludingDeleted(transaction.id(), user.groupId()).orElseThrow();
        ...
        void shouldBulkCreateTransactionsAndSkipDuplicates() {
                ...
                var categoryId = createIncomeCategory(userId);
                var accountId = accountModuleFacade
                        .createAccount(new CreateAccountCommand(uniqueAccountName(), PLN, userId)).id();
                ...
                var result = transactionService
                        .bulkCreateTransactions(new BulkCreateTransactionCommand(accountId, commands), userId);
