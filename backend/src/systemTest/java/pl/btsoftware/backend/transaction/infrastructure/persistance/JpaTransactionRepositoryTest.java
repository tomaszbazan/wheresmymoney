...
public class JpaTransactionRepositoryTest {
    ...
    class TransactionFilteringTest {
        ...
        void shouldFilterByAccountIds() {
            ...
            var transaction1 = createTransaction(accountId1, Money.of(TEN, EUR), "Acc 1", EXPENSE, categoryId, auditInfo);
            var transaction2 = createTransaction(accountId2, Money.of(TEN, EUR), "Acc 2", EXPENSE, categoryId, auditInfo);

            transactionRepository.store(transaction1);
            transactionRepository.store(transaction2);

            var criteria = new TransactionSearchCriteria(Set.of(), null, null, null, null, Set.of(accountId1), Set.of(), null);
        ...
        void shouldFilterByCategoryIds() {
            ...
            var transaction1 = createTransaction(accountId, Money.of(TEN, EUR), "Cat 1", EXPENSE, categoryId1, auditInfo);
            var transaction2 = createTransaction(accountId, Money.of(TEN, EUR), "Cat 2", EXPENSE, categoryId2, auditInfo);

            transactionRepository.store(transaction1);
            transactionRepository.store(transaction2);

            var criteria = new TransactionSearchCriteria(Set.of(), null, null, null, null, Set.of(), Set.of(categoryId1), null);
        ...
        void shouldFilterByDescription() {
            ...
            var transaction2 = createTransaction(accountId, Money.of(TEN, EUR), "Car fuel", EXPENSE, categoryId, auditInfo);
