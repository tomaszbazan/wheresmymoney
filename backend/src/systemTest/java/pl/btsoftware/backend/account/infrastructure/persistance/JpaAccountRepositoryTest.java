...
public class JpaAccountRepositoryTest {
    ...
    void shouldStoreAndRetrieveAccount() {
        ...
        var account =
                new Account(AccountId.generate(), "Test Account", balance, auditInfo, auditInfo, Tombstone.active());
    ...
    void shouldFindAllAccountsByGroup() {
        ...
        var accountGroupX1 = new Account(
                AccountId.generate(),
                "Group X Account 1",
                Money.of(BigDecimal.ZERO, PLN),
                auditInfoGroupX,
                auditInfoGroupX,
                Tombstone.active());
        var accountGroupX2 = new Account(
                AccountId.generate(),
                "Group X Account 2",
    ...
    void shouldAllowUpdateWithCorrectVersion() {
        ...
        // then
        var retrievedEntity =
                accountJpaRepository.findById(account.id().value()).orElseThrow();
