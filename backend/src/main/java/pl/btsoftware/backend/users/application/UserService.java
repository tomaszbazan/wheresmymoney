...
public class UserService {
    ...
    public User registerUser(RegisterUserCommand command) {
        userRepository.findById(new UserId(command.externalAuthId())).ifPresent(user -> {
    ...
    private User registerUserToExistingGroup(RegisterUserCommand command) {
        ...
        var user = User.create(new UserId(command.externalAuthId()), command.email(), command.displayName(), groupId);
    ...
    private User registerUserInNewGroup(RegisterUserCommand command) {
        ...
        var user = User.create(
                new UserId(command.externalAuthId()), command.email(), command.displayName(), GroupId.generate());
