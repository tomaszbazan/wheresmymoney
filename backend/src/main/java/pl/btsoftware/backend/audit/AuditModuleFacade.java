...
public class AuditModuleFacade {
    ...
    public void logAccountCreated(
            AccountId accountId, String accountName, UserId userId, GroupId groupId) {
        var description = "Account created: " + accountName;
        auditLogService.logCreate(
                ACCOUNT, EntityId.from(accountId.value()), userId, groupId, description);
    }

    public void logAccountUpdated(
            AccountId accountId, String oldName, String newName, UserId userId, GroupId groupId) {
    ...
    public void logTransactionCreated(
            TransactionId transactionId, String description, UserId userId, GroupId groupId) {
        var logDescription = "Transaction created: " + description;
        auditLogService.logCreate(
                TRANSACTION, EntityId.from(transactionId.value()), userId, groupId, logDescription);
    }

    public void logTransactionUpdated(
            TransactionId transactionId, String description, UserId userId, GroupId groupId) {
    ...
    public void logCategoryCreated(
        ...
        auditLogService.logCreate(
                CATEGORY, EntityId.from(categoryId.value()), userId, groupId, description);
    }
    ...
    public void logCategoryDeleted(
            CategoryId categoryId, String categoryName, UserId userId, GroupId groupId) {
