...
public class AuditModuleFacade {
    ...
    public void logAccountCreated(AccountId accountId, String accountName, UserId userId, GroupId groupId) {
        ...
        auditLogService.logCreate(ACCOUNT, EntityId.from(accountId.value()), userId, groupId, description);
    }
    ...
    public void logAccountUpdated(AccountId accountId, String oldName, String newName, UserId userId, GroupId groupId) {
        ...
        auditLogService.logUpdate(ACCOUNT, EntityId.from(accountId.value()), userId, groupId, description);
    }
    ...
    public void logAccountDeleted(AccountId accountId, String accountName, UserId userId, GroupId groupId) {
        ...
        auditLogService.logDelete(ACCOUNT, EntityId.from(accountId.value()), userId, groupId, description);
    }

    public void logAccountWithdraw(
            AccountId accountId, String accountName, UserId userId, GroupId groupId, Money amount) {
        var description = "Account withdraw: " + accountName + ", amount: " + amount;
        auditLogService.logUpdate(ACCOUNT, EntityId.from(accountId.value()), userId, groupId, description);
    }

    public void logAccountDeposit(
            AccountId accountId, String accountName, UserId userId, GroupId groupId, Money amount) {
    ...
    public void logTransactionCreated(TransactionId transactionId, String description, UserId userId, GroupId groupId) {
        ...
        auditLogService.logCreate(TRANSACTION, EntityId.from(transactionId.value()), userId, groupId, logDescription);
    }
    ...
    public void logTransactionUpdated(TransactionId transactionId, String description, UserId userId, GroupId groupId) {
        ...
        auditLogService.logUpdate(TRANSACTION, EntityId.from(transactionId.value()), userId, groupId, logDescription);
    }
    ...
    public void logTransactionDeleted(TransactionId transactionId, String description, UserId userId, GroupId groupId) {
        ...
        auditLogService.logDelete(TRANSACTION, EntityId.from(transactionId.value()), userId, groupId, logDescription);
    }

    public void logCategoryCreated(
            CategoryId categoryId, String categoryName, String categoryType, UserId userId, GroupId groupId) {
        var description = "Category created: " + categoryName + " (" + categoryType + ")";
        auditLogService.logCreate(CATEGORY, EntityId.from(categoryId.value()), userId, groupId, description);
    }

    public void logCategoryUpdated(
            CategoryId categoryId, String oldName, String newName, UserId userId, GroupId groupId) {
        var description = "Category updated: " + oldName + " → " + newName;
        auditLogService.logUpdate(CATEGORY, EntityId.from(categoryId.value()), userId, groupId, description);
    }
    ...
    public void logCategoryDeleted(CategoryId categoryId, String categoryName, UserId userId, GroupId groupId) {
        ...
        auditLogService.logDelete(CATEGORY, EntityId.from(categoryId.value()), userId, groupId, description);
    }
}
