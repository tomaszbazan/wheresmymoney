...
class GeminiResponseParserTest {
    ...
    void shouldParseValidJsonArrayToListOfCategorySuggestions() {
        ...
        assertThat(first.transactionProposalId().value()).isEqualTo(UUID.fromString(transactionId1));
    ...
    void shouldHandleNullCategoryIdInSuggestion() {
        ...
        assertThat(result.getFirst().transactionProposalId().value()).isEqualTo(UUID.fromString(transactionProposalId));
    ...
    void shouldReturnOnlyValidSuggestionsWhenMixedValidInvalid() {
        ...
        // then
        assertThat(result).hasSize(1);
        assertThat(result.getFirst().transactionProposalId().value()).isEqualTo(UUID.fromString("6f47f47a-282c-419d-b9c5-22d6b0007fd3"));
    }
