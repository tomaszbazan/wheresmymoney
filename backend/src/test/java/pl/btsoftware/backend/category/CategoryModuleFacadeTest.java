...
class CategoryModuleFacadeTest {
    ...
    void shouldUpdateCategory() {
        ...
        var updateCommand = new UpdateCategoryCommand(category.id(), "Updated Category", Color.of("#FF0000"), null);
    ...
    void shouldCheckIfHasCategories() {
        ...
        assertThat(categoryModuleFacade.hasCategories(CategoryType.EXPENSE, groupId))
                .isFalse();
