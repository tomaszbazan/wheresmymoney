...
| TASK-0024 | Group settings UI              | Create Flutter screen for managing group settings and invitation codes | [ ]  |
...
| TASK-0033 | Category deletion validation | Block deletion of categories with assigned transactions               | [ ]  |
